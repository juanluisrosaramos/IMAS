...
public class HarvesterInfoAgent extends InfoAgent {
    ...
    public GarbageType[] getAllowedTypes() {
        return allowedTypes;
    }
    ...
    @Override
    public HarvesterInfoAgent clone() throws CloneNotSupportedException {
        HarvesterInfoAgent hi= new HarvesterInfoAgent(this.getType(),this.getAllowedTypes(),this.capacity);
        hi.setAID(this.getAID());
        return hi;
    }
