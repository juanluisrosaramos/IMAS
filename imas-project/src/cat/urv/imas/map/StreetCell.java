...
public class StreetCell extends Cell {
    ...
    public StreetCell(CellType type, int row, int col) {
        super(type, row, col);
    }
    ...
    @Override
    public StreetCell clone() throws CloneNotSupportedException {
        StreetCell n = new StreetCell(this.getRow(),this.getCol());
        n.agent =  (InfoAgent) this.agent.clone();
        return n;
    }
